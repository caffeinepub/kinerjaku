...
export class Backend implements backendInterface {
    ...
    async createOrUpdateEmployeeProfile(arg0: EmployeeProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrUpdateEmployeeProfile(to_candid_EmployeeProfile_n3(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createPerformanceRecord(arg0: {
        employeeName: string;
        realisasi: bigint;
        date: string;
        task: string;
        ...
        if (this.processError) {
            try {
                const result = await this.actor.createPerformanceRecord(to_candid_record_n5(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPerformanceRecords(): Promise<Array<PerformanceRecord>> {
        if (this.processError) {
            try {
    ...
    async getEmployeeProfile(arg0: Principal): Promise<EmployeeProfile | null> {
        if (this.processError) {
            try {
    ...
    async getPerformanceRecordsByEmployee(arg0: Principal): Promise<Array<PerformanceRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPerformanceRecordsByEmployee(arg0);
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_PerformanceRecord_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PerformanceRecord): PerformanceRecord {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_EmployeeProfile]): EmployeeProfile | null {
    return value.length === 0 ? null : from_candid_EmployeeProfile_n7(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PerformanceRecord>): Array<PerformanceRecord> {
    return value.map((x)=>from_candid_PerformanceRecord_n12(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_EmployeeProfile>): Array<EmployeeProfile> {
    return value.map((x)=>from_candid_EmployeeProfile_n7(_uploadFile, _downloadFile, x));
}
function to_candid_EmployeeProfile_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: EmployeeProfile): _EmployeeProfile {
...
function to_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        target: value.target,
        employeeId: value.employeeId,
        fileBuktiUrl: value.fileBuktiUrl ? candid_some(value.fileBuktiUrl) : candid_none()
    };
}
